...
import LiveCodeSnippetBreakdown from "../assets/img/live-code-snippet-breakdown.png";
import StageResize from "../assets/video/stage-resize.mp4";
...
<AppImage src={LiveCodeSnippetBreakdown} alt="Live code snippet diagram" />
